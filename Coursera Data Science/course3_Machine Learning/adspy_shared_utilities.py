...
def load_crime_dataset():
    ...
    columns_to_keep = [5, 6] + list(range(11,26)) + list(range(32, 103)) + [145]   #war .ix, nicht mehr gültig
    crime = crime.iloc[:,columns_to_keep].dropna()

    X_crime = crime.iloc[:,range(0,88)]  #war .ix, nicht mehr gültig
...
def plot_fruit_knn(X, y, n_neighbors, weights):
    X_mat = X[['height', 'width']].values # Korrektur
    y_mat = y.values # Korrektur, was .as_matrix
